...
class Color{
	...
	public static float a_icon = 0.5f;
}
...
public class Title
{
	...
	public Title(float x, float y, float radius )	//衝突判定の情報を入れる
	{
	...
	public void draw_Color_Custom(GL10 gl, int x, int y, int texture, float tex_h, float tex_w, float rect[], float r, float g, float b, float a)
	{
